...
## changing (increasing) the number of features to observe the change in f1 score
#n_components = 200
...
## (ANS 2)
## Hence with the increase in numner of features the f1-score can go either way,
## ie it may increase in some cases or decrease (due to overfitting)
